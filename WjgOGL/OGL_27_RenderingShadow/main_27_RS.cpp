...
int main()
{
	...
	//生成深度贴图
	Shader GenerateShadowMapShader("Shader/27_RS/GenerateShadowMap.vs", "Shader/27_RS/GenerateShadowMap.fs");
	//使用深度贴图
	Shader ApplyShadowMapShader("Shader/27_RS/ApplyShadowMap.vs", "Shader/27_RS/ApplyShadowMap.fs");
