...
int main()
{
	...
	//生成深度贴图
	Shader GenerateShadowMapShader("Shader/27_GSM/GenerateShadowMap.vs", "Shader/27_GSM/GenerateShadowMap.fs");
	//渲染深度贴图到一个quad上
	Shader RenderShadowMapShader("Shader/27_GSM/shader.vs", "Shader/27_GSM/shader.fs");
	...
	*/
	...
	RenderShadowMapShader.use();
	RenderShadowMapShader.setInt("depthMap", 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//渲染深度贴图到窗口上
		RenderShadowMapShader.use();
		RenderShadowMapShader.setFloat("near_plane", near_plane);
		RenderShadowMapShader.setFloat("far_plane", far_plane);
		glActiveTexture(GL_TEXTURE0);
		glBindTexture(GL_TEXTURE_2D, depthMap);
		renderQuad();
