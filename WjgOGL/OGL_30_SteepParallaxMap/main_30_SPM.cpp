...
//视差贴图缩放参数，视差效果如果没有一个缩放参数通常会过于强烈
...
int main()
{
	...
	//视差贴图shader
	Shader ParallaxMapShader("Shader/30_SPM/ParallaxMap.vs", "Shader/30_SPM/ParallaxMap.fs");
	...
	ParallaxMapShader.setInt("heightMap", 2);
