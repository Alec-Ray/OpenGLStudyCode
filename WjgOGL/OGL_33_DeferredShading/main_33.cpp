...
int main()
{
	...
	Shader shaderGeometryPass("Shader/33/g_buffer.vs", "Shader/33/g_buffer.fs");
	//用作光照处理，我们从G缓冲当中拿数据
	Shader shaderLightingPass("Shader/33/deferred_shading.vs", "Shader/33/deferred_shading.fs");
	//把光源渲染成立方体
	Shader shaderLightBox("Shader/33/light_box.vs", "Shader/33/light_box.fs");
