...
int main()
{
	...
	//本节不需要用到EBO(索引缓冲对象)，因为我们直接用了36个顶点数据来构建立方体
	//如果用EBO的话，应该8个顶点就够了
	////索引
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 model = glm::mat4(1.0f);				//模型矩阵，局部坐标到世界坐标
		glm::mat4 view = glm::mat4(1.0f);				//观察者矩阵
		glm::mat4 projection = glm::mat4(1.0f);			//透视投影矩阵
